...
<head>
<meta charset="utf-8">
<title>UConnect private Chat</title>
...
if($user){
			...
			die("You must be logged in to view this page <a href='localhost/UConnect'>Login here!</a>");
		}
if(isset($_GET['u'])){
...
<div>&nbsp;</div><div>&nbsp;</div>
<div style="width: 80%; height: 500px; position:relative; margin-top:2%; margin: 0px auto; border:3px solid #0FF;">
