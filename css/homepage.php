...
<?php
	...
	echo  ($username != $user)? $addAsFriend: '';
		...
		$addAsFriend = '<input type="submit" name= "cancelRequest" value ="CancelRequest" style = "background-color:#50F; font-size: 12px;" />';
...
<div class="rightSider">
    ...
    <?php
        ...
        if($user == $username){
                echo '<tr><td><a href="accountSetting.php" style =" font-size: 10px;
                font-weight: bold; color: blue;">Go to Account Setting to Edit profile</a></td></tr>';
        }
	 }
	?>
    </table>
