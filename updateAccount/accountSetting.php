    ...
    <?php
        ...
        ?>
         <a rel="tooltip"  title="Edit" id="e<?php echo $id; ?>" href="#edit<?php echo $id; ?>" 
                data-toggle="modal" class="btn btn-success"><i class="icon-pencil icon-large">
                </i></a>
...
<?php /*?>SECTION FOR CHANGING PASSWORD<?php */?>
    <table>
        <tr>
            <td><form action="account_settings.php" method="POST" id='customPassword'>
    ...
    <hr />
       <table><tr>
        <td>
            ...
            <?php /*?>SECTION FOR CHANGING NAMES AND PROFILE MESSAGE<?php */
        
        	$getUserInfo = mysql_query("SELECT * FROM users WHERE username = '$user'");
        	$fname ='';
        	$lname = '';
        	$email = '';
        	$phone = '';
        ...
        ?>
        <h2 id="click-edit" style="color: #00BFFF; font-family: pristina; font-size: 25px;">Edit Your names and say something about yourself:</h2> <br />
       ...
       <td><input type="text" name ="fname" id="fname" size="25" placeholder="First name"  value="<?php  echo $fname ?>" class="changeInfo"/></td>
       </tr>
       
       <tr><td><label>Last name:</label></td>
       <td><input type="text" name ="lname" id="lname" size="25" placeholder="Last name" value="<?php echo $lname ?>" class="changeInfo"/></td>
       </tr>
       
       <tr><td><label>Email:</label></td>
       <td><input type="text" name ="email" id="email" size="25" placeholder="Email:" value="<?php echo $email ?>" class="changeInfo"/></td>
       </tr>
          <tr>
              <td><label>Select Country</label></td>
              <td><select id="country" name ="country" onChange="populateCountries(this.id,'state')"></select><span id ="countryInfo">(Optional)</span></td>
          </tr>
          <tr>          
              <td><label>Select State</label></td>
              <td><select name ="state" id ="state"></select><span id ="stateInfo">(Optional)</span></td>
                    	<script language="javascript">
        				populateCountries("country", "state");
         			</script> 
         </tr>
        <tr><td><label>About You:</label> </td><td><textarea name="bio" id="bio" cols="60" rows ="7" class="changeInfo"><?php echo $aboutMe ?></textarea></td></tr>
        
        <tr><td><input type="submit" name ="updateinfo" id ="updateinfo"value="Update Information"/></td></tr>
        <!--<input type="submit" name ="updateinfo" id ="updateinfo"value="Update Information" onclick="update_function()"/> -->
        	<tr id="response"></tr>
        </form>
